#!/usr/bin/env python3
"""
STEP 2: Language Classification Integration Test
Tests language detection pipeline with langdetect library
Detects 50+ languages with confidence scoring (en, fr, es, etc.)
"""
