#!/usr/bin/env python3
"""
STEP 1: Email Classification Integration Test
Tests email classification pipeline (personal/promotional/automated)
Uses SimpleRuleClassifier with LLM fallback via llm library
"""
